report 50316 StandardStatementNew
{
                ...
                dataitem(CurrencyLoop; Integer)
                {
                    ...
                    dataitem(CustLedgEntryHdr; Integer)
                    {
                        ...
                        dataitem(DtldCustLedgEntries; "Detailed Cust. Ledg. Entry")
                        {
                            ...
                            column(RemainAmt_DtldCustLedgEntries; recAmntBuf."Column 1 Amt.")//RemainingAmount)
                            {
                                AutoFormatExpression = "Currency Code";
                                AutoFormatType = 1;
                            }
                            ...
                            column(formatDecimal; cduFormatMgt.getRDLFormatDecimalPlace("Currency Code", 1))
                            {

                            }
                            column(LanguageCode; cduFormatMgt.getRDLLangueCode("Currency Code"))
                            {
                            }
                                ...
                                CASE "Entry Type" OF
                                    "Entry Type"::"Initial Entry":
                                        BEGIN
                                            ...
                                            recAmntBuf."Column 1 Amt." := CustLedgerEntry."Remaining Amount";
    ...
    var
        ...
        recAmntBuf: Record "Aging Band Buffer" temporary;
