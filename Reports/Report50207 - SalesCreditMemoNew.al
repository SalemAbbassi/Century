report 50207 "SalesCreditMemoNew"
{
    ...
    dataset
    {
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            column(SalesHeaderExtDocNo; "Sales Cr.Memo Header"."External Document No.")
            {
            }
            column(SalesHeaderYourRef; "Sales Cr.Memo Header"."Your Reference")
            {
            }
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(PricesInclVAT_SalesInvHeaderCaption; "Sales Cr.Memo Header".FIELDCAPTION("Prices Including VAT"))
                    {
                    }
                    ...
                    column(ShptDate_SalesInvHeader; FORMAT("Sales Cr.Memo Header"."Shipment Date"))
                    {
                    }
                    column(DueDate_SalesInvHeader; FORMAT("Sales Cr.Memo Header"."Due Date", 0, '<Day,2>.<Month,2>.<Year4>'))
                    {
                    }
                    ...
                    column(SalesInvoiceReference_InvoiceHeader; "Sales Cr.Memo Header"."External Document No.")
                    {
                    }
                    ...
                    column(SalesOrderReference_SalesInvHeader; "Sales Cr.Memo Header"."Return Order No.")
                    {
                    }
                    ...
                    column(PricesInclVAT_SalesInvHeader; "Sales Cr.Memo Header"."Prices Including VAT")
                    {
                    }
                    column(OutputNo; OutputNo)
                    {
                    }
                    column(PricesInclVATYesNo_SalesInvHeader; FORMAT("Sales Cr.Memo Header"."Prices Including VAT"))
                    {
                    }
                    ...
                    column(SalesHeaderSellCustNo; "Sales Cr.Memo Header"."Sell-to Customer No.")
                    {
                    }
                    ...
                    dataitem("Sales Cr.Memo Line"; integer)//"Sales Cr.Memo Line")                    
                    {
                        ...
                        */
                        ...
                        column(Type_SalesInvLine; format(recSalesInvoiceLineTMP.type))//FORMAT("Sales Cr.Memo Line".Type))
                        {
                        }
                        ...
                        column(LineAmt_SalesInvLine; recSalesInvoiceLineTMP."Line Amount") //"Sales Cr.Memo Line"."Line Amount")
                        {
                            AutoFormatExpression = "Sales Cr.Memo Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(SubtotalNet_SalesInvLine; -1)//recSalesInvoiceLineTMP."Subtotal net") //"Sales Cr.Memo Line"."Subtotal Net")
                        {
                            AutoFormatExpression = recSalesInvoiceLineTMP.GetCurrencyCode; //GetCurrencyCode;
                            AutoFormatType = 1;
                        }
                        ...
                        column(VATBaseDisc_SalesInvHeader; "Sales Cr.Memo Header"."VAT Base Discount %")
                        {
                            AutoFormatType = 1;
                        }
                        ...
                        column(No2_SalesInvLine; recSalesInvoiceLineTMP."Description 2")// "Sales Cr.Memo Line"."Description 2")
                        {
                        }
                        column(Qty_SalesInvLine; recSalesInvoiceLineTMP.Quantity) //"Sales Cr.Memo Line".Quantity)
                        {
                        }
                        ...
                        column(extref; recSalesInvoiceLineTMP.ExtRef) //"Sales Cr.Memo Line".ExtRef)
                        {
                        }
                        ...
                        dataitem("Sales Shipment Buffer"; Integer)
                        {
                            ...
                            trigger OnPreDataItem()
                            begin
                                SalesShipmentBuffer.SETRANGE("Document No.", recSalesInvoiceLineTMP."Document No.");// "Sales Cr.Memo Line"."Document No.");
                                SalesShipmentBuffer.SETRANGE("Line No.", recSalesInvoiceLineTMP."Line No.");// "Sales Cr.Memo Line"."Line No.");
                        ...
                        var
                            ...
                            recSalesLine2: Record "Sales Cr.Memo Line";
                        ...
                        begin
                            ...
                            if recSalesInvoiceLineTMP.type = recSalesInvoiceLineTMP.type::item then begin
                                ...
                                if recSalesLine.Findfirst then begin
                                    ...
                                    recExtTextHeader.SETRANGE("Sales Credit Memo", TRUE);
                                    recExtTextHeader.SETCURRENTKEY(
                                        "Table Name", "No.", "Language Code", "All Language Codes", "Starting Date", "Ending Date");
                                    recExtTextHeader.SETRANGE("Starting Date", 0D, "Sales Cr.Memo Header"."Document Date");
                                    recExtTextHeader.SETFILTER("Ending Date", '%1..|%2', "Sales Cr.Memo Header"."Document Date", 0D);
                                    IF "Sales Cr.Memo Header"."Language Code" = '' THEN
                                        recExtTextHeader.SETRANGE("Language Code", '')
                                    else
                                        recExtTextHeader.SETRANGE("Language Code", "Sales Cr.Memo Header"."Language Code");
                            ...
                            if (recSalesInvoiceLineTMP.Type = recSalesInvoiceLineTMP.Type::Item) AND (recItem.Get(recSalesInvoiceLineTMP."No.")) and (recItem.Type = recItem.Type::Service) then begin
                                ...
                                if recExtTextHeader.FindFirst() then begin
                                    ...
                                    IF "Sales Cr.Memo Header"."Language Code" = '' THEN
                                        ...
                                        RecExtTextLine.SETRANGE("Language Code", "Sales Cr.Memo Header"."Language Code");
                                ...
                                recSalesLineItemServiceTMP.TransferFields(recSalesInvoiceLineTMP);//"Sales Cr.Memo Line");
                                ...
                                NNCPmtDiscOnVAT := -VATAmountLine.GetTotalVATDiscount("Sales Cr.Memo Header"."Currency Code", "Sales Cr.Memo Header"."Prices Including VAT");
                                ;
                ...
                trigger OnAfterGetRecord()
                var
                    recSalesInvLine: record "Sales Cr.Memo Line";
                    recTrackingLine: Record "Reservation Entry";
                    txtSerialInfos: array[100] of Text[50];
                    inttab: Integer;
                    recSalesLineTMP: Record "Sales Cr.Memo Line" temporary;
                ...
                begin
                    ...
                    recSalesInvLine.setfilter("Document No.", '%1', "Sales Cr.Memo Header"."No.");
                    ...
                    if recSalesInvoiceLineTMP.FindSet() then
                        repeat
                            if recSalesInvoiceLineTMP.Type = recSalesInvoiceLineTMP.Type::Item then begin
                                ...
                                txt1 := ItemTrackingMgt.ComposeRowID(DATABASE::"Sales Cr.Memo Line", 0, recSalesInvoiceLineTMP."Document No.", '', 0, recSalesInvoiceLineTMP."Line No.");
                    ...
                    CompressArray(txtSerialInfos);
                    if CompressArray(txtSerialInfos) > 0 then begin
                        for inttab := 1 to CompressArray(txtSerialInfos) do begin
                            recSalesLineTMP.init();
                            recSalesLineTMP."Document No." := "Sales Cr.Memo Header"."No.";
                            recSalesLineTMP."Line No." := intlineNoSrc + (inttab * 100);
                            recSalesLineTMP.Insert(false);
                            recSalesLineTMP.Type := recSalesLineTMP.Type::" ";
            ...
            begin
                ...
                if not recTransportMethod.Get("Sales Cr.Memo Header"."Transport Method") then
                    recTransportMethod.init;

                recUser.SetCurrentKey("User Name");
                recUser.SetFilter("User Name", '%1', "Sales Cr.Memo Header"."User ID");
                if not recUser.FindFirst() then
                    recUser.Init();

                if recCurrency.get("Sales Cr.Memo Header"."Currency Code") then begin
    ...
    var
        ...
        recSalesInvoiceLineTMP: Record "Sales Cr.Memo Line" temporary;
        ...
        InvoiceNoCaptionLbl: Label 'Credit Note No.';
        ...
        NewPageLine: Boolean;
        recUser: record "User";
        recSalesLineItemServiceTMP: record "Sales Cr.Memo Line" temporary;
