page 50107 "DBESalesOrderConsignment"
{
    Caption = 'Sales Order Consignment';
    PageType = Document;
            ...
            group("&Print")
            {
                ...
                action("Picking List")
                {
                    ...
                    begin
                        ...
                        REPORT.Run(REPORT::"Picking List", true, false, SalesHead);
                    end;
                }
    ...
    begin
        xRec.Init;
        DBESubType := DBESubType::Consignment;
        "External Document No." := 'KONSIGNATION';
